Contributing to FydCoin Core
============================

The FydCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FydCoin Core project, and is not to be
confused with overall FydCoin Network Protocol consensus changes.

Whether a pull request is merged into FydCoin Core rests with the project merge
...
Patches that change FydCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the FydCoin consensus, it must have been
...
The project leader is the release manager for each FydCoin Core release.
