...
In order to support loading of multiple wallets in fyd-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fyd.cpp.
...
Changes to fyd.cpp
----------------------
fyd.cpp is the entry point into fyd-qt, and as such, will require some minor modifications to provide hooks for
