...
FydCoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fyd_address\> \<monthly_payment_fyd\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ FydCoin, _12_ times over the course of a year totaling _24000_ FydCoin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fyd_address\> \<monthly_payment_fyd\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` FydCoin.
 ...
 * vote-many          - Vote on a FydCoin initiative
 * vote-alias         - Vote on a FydCoin initiative
 * vote               - Vote on a FydCoin initiative/budget
