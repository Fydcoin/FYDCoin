...
This mechanism has been integrated into Bitcore-Node-FydCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FydCoin/insight-api-fyd#web-socket-api](https://github.com/FydCoin/insight-api-fyd#web-socket-api) 
* API: [https://github.com/FydCoin/insight-api-fyd#swifttx-transactions](https://github.com/FydCoin/insight-api-fyd#swifttx-transactions) 
...
By default, the FydCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FydCoin Core daemon:
