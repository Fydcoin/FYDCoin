...
RESOURCES += src/qt/fyd.qrc src/qt/fyd_locale.qrc

TRANSLATIONS += src/qt/locale/fyd_bg.ts \
                src/qt/locale/fyd_de.ts \
                src/qt/locale/fyd_en.ts \
                src/qt/locale/fyd_es.ts \
                src/qt/locale/fyd_fi.ts \
                src/qt/locale/fyd_fr.ts \
                src/qt/locale/fyd_it.ts \
                src/qt/locale/fyd_ja.ts \
                src/qt/locale/fyd_pl.ts \
                src/qt/locale/fyd_pt.ts \
                src/qt/locale/fyd_ru.ts \
                src/qt/locale/fyd_sk.ts \
                src/qt/locale/fyd_sv.ts \
                src/qt/locale/fyd_vi.ts \
                src/qt/locale/fyd_zh_CN.ts \
                src/qt/locale/fyd_zh_TW.ts
