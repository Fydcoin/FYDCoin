...
#ifndef FYD_ZFYDTRACKER_H
#define FYD_ZFYDTRACKER_H
...
public:
    CzFYDTracker(std::string strWalletFile);
    ~CzFYDTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFYDWallet* zFYDWallet = NULL);
