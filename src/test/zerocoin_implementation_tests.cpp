...
std::string rawTxSerial3 = "3abf349844720374925d129c95402edbc85d86fff89632a05dc18970560047a5";
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzFYDWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZFYD(denom, coin, dMint);
