...
#ifndef FYD_ZFYDWALLET_H
#define FYD_ZFYDWALLET_H
...
public:
    CzFYDWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZFYD(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFYD(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
