...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FydCoin Core fyd-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fyd-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fyd transaction") + "\n" +
                               "  fyd-tx [options] -create [commands]   " + _("Create hex-encoded fyd transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fyd transaction
