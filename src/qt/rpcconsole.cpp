                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFYDPathCustom = GetArg("-zfydbackuppath", "");
    ...
    if(!strzFYDPathCustom.empty()) {
        ui->wallet_customzfydbackuppath->setText(QString::fromStdString(strzFYDPathCustom));
        ui->wallet_customzfydbackuppath_label->setVisible(true);
        ui->wallet_customzfydbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFYDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FYD RPC console.") + "<br>" +
