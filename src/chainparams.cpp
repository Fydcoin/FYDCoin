...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04541a0a55ecb4fbae43bc3fc95ab4647008cfc858548302e79f5ed7416076a274f51fa330f763a8022524df82f0591224fe36242c196f940bf9f5d0b90dd8d37a");
        nDefaultPort = 37485;
...
//        nSubsidyHalvingInterval = 210000;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // FydCoin: 1 day
        nTargetSpacing = 1 * 60;  // FydCoin: 1 minute
        nMaturity = 100;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "25/Mar/2019 FYD coin released";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1553501329;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 108539;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000b38f21cd5cec9a047797e6422aeadfab829ac97d8276fba81aa15c91094"));
        assert(genesis.hashMerkleRoot == uint256("0x047ed76e09e79e736a3b30a7f895b562008975b8a4aad84166c385312928d032"));

//        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "fyd.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
//        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "fyd.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
//        vSeeds.push_back(CDNSSeedData("coin-server.com", "coin-server.com"));         // Single node address
//        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net")); // Single node address
//        vSeeds.push_back(CDNSSeedData("178.254.23.111", "178.254.23.111"));           // Single node address
//        vSeeds.push_back(CDNSSeedData("explorer.fydcoin.com", "explorer.fydcoin.com"));
//        vSeeds.push_back(CDNSSeedData("seed1.fydcoin.com", "seed1.fydcoin.com"));
//        vSeeds.push_back(CDNSSeedData("seed2.fydcoin.com", "seed2.fydcoin.com"));
...
//        vSeeds.push_back(CDNSSeedData("seed5.fydcoin.com", "seed5.fydcoin.com"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zfyd to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04ea570528dd0a799c8da9f9d92a98abe12a1d9b6b45bc3528bc91118098781c7ec0cccc52a2e05294f4b5d6a035aa30e5df4b716bc65d391345bab9fb2b7565b6");
        nDefaultPort = 37490;
...
//        assert(hashGenesisBlock == uint256("0x0000041e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "fyd-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "fyd-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140); // Testnet fyd addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet fyd script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet fyd BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet fyd BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet fyd BIP44 coin type is '1' (All coin's testnet default)
