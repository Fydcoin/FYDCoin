...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FYD features */
        {"fyd", "masternode", &masternode, true, true, false},
        {"fyd", "listmasternodes", &listmasternodes, true, true, false},
        {"fyd", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fyd", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fyd", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fyd", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fyd", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fyd", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fyd", "masternodedebug", &masternodedebug, true, true, false},
        {"fyd", "startmasternode", &startmasternode, true, true, false},
        {"fyd", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fyd", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fyd", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fyd", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fyd", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fyd", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fyd", "mnbudget", &mnbudget, true, true, false},
        {"fyd", "preparebudget", &preparebudget, true, true, false},
        {"fyd", "submitbudget", &submitbudget, true, true, false},
        {"fyd", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fyd", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fyd", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fyd", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fyd", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fyd", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fyd", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fyd", "checkbudgets", &checkbudgets, true, true, false},
        {"fyd", "mnsync", &mnsync, true, true, false},
        {"fyd", "spork", &spork, true, true, false},
        {"fyd", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> fyd-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37486/\n";
}
