...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zfydObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zfydObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
...
UniValue getchecksumblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"zFYDsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zFYD denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zFYD denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zFYD denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zFYD denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zFYD denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zFYD denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zFYD denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zFYD denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zFYD denominations\n"
            "  }\n"
            "}\n"
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in fyd\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of fyd addresses\n"
...
UniValue getaccumulatorwitness(const UniValue& params, bool fHelp)
{
    ...
    if (!GenerateAccumulatorWitness(pubCoin, accumulator, witness, 100, nMintsAdded, strFailReason)) {
        receipt.SetStatus(_(strFailReason.c_str()), ZFYD_FAILED_ACCUMULATOR_INITIALIZATION);
