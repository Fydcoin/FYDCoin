...
extern UniValue setzfydseed(const UniValue& params, bool fHelp);
extern UniValue getzfydseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzfyd(const UniValue& params, bool fHelp);
extern UniValue dzfydstate(const UniValue& params, bool fHelp);
